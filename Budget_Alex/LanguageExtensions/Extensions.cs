...
namespace Budget_Alex
{
    public static class Extensions
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool IsValidBudget(this DataEntity.Budget sender)
        {
            return (sender != null);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DataEntity.Budget BudgetCurrent(this BindingSource sender)
        {
            return ((DataEntity.Budget)sender.Current);
        }


        public static Classes.BudgetResult ResultCurrent(this BindingSource sender)
        {
            return ((Classes.BudgetResult)sender.Current);
        }
